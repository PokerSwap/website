...
<p>Swap Profit, LLC. (“Swap Profit,” “we,” “us,” “our”) provides its services (described below) to you through its websites located at www.swapprofitonline.com and through its mobile applications and related services (collectively, such services, including any new features and applications, and the Site, the “Service(s)”), subject to the following Terms of Service (as amended from time to time, the “Terms of Service”). We reserve the right, at our sole discretion, to change or modify portions of these Terms of Service at any time. If we do this, we will post the changes on this page and will indicate at the top of this page the date these terms were last revised. We will also notify you, either through the Services user interface, in an email notification or through other reasonable means. Any such changes will become effective no earlier than fourteen (14) days after they are posted, except that changes addressing new functions of the Services or changes made for legal reasons will be effective immediately. Your continued use of the Service after the date any such changes become effective constitutes your acceptance of the new Terms of Service.</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>Swap Profit Rewards Program</p>
<p>General: As part of the Services, Swap Profit lets you accumulate rewards by buying certain products with an associated Swap Profit Rewards value (a "Swap Profit Offer"). We have created mobile applications and websites that let our members upload or email photos of their receipts so we can validate their purchase of products and services associated with a Swap Profit Offer and begin to accumulate Swap Profit Rewards. We may also validate our members’ purchase of products associated with a Swap Profit Offer through retailer or other partner-provided transaction log data, receipt data using a unique identifier (such as a loyalty card number, credit card number, phone number, etc.) to match a Swap Profit member to a transaction, or the user’s location as determined by the phone.</p>
<p>&nbsp;</p>
<p>You are only permitted to earn Swap Profit Rewards on purchases and transactions that you personally have made. If we discover that you have (1) violated the foregoing, (2) provided us with receipts or purchase confirmations for purchases and transactions made by someone other than you, or (3) provided us with fraudulent or erroneous receipts or purchase confirmations, we may deactivate your account in our sole discretion and/or deduct any fraudulently earned Swap Profit Rewards from your account.</p>
<p>&nbsp;</p>
<p>Exchanging Swap Profit Rewards: You may redeem Swap Profit Rewards solely by using it toward certain approved purchases as described in the Services. Swap Profit Rewards may only be redeemed at the particular establishment where such Swap Profit Rewards were earned. The Services may impose a limit to the number of Swap Profit Rewards that can be applied to a particular purchase. Once the Swap Profit Rewards are redeemed, your Rewards balance shall be credited with the amount of Swap Profit Rewards redeemed. In the event a merchant ceases being part of the Services, we may allow you to transfer the Swap Profit Rewards for such merchant to another merchant, but we are not obligated to do so.</p>
<p>&nbsp;</p>
<p>No interest is paid on Swap Profit Rewards balances. You have no property rights or other legal interest in the Swap Profit Rewards for any purpose. All Swap Profit Rewards remain the sole property of Swap Profit until redeemed per these Terms of Service. Except as otherwise provided herein, your Swap Profit Rewards balance or any part of it is not transferable, cannot be divided as part of a settlement, legal proceeding or death, and cannot be combined with Swap Profit Rewards of any other user of the Services.&nbsp;</p>
<p>&nbsp;</p>
...
<p>Minus</p>
<p>One (1) original price of entry</p>
<p>Equals:</p>
<p>Profits that will be counted towards Swap Payouts.</p>
<p>If the event the User is competing in is a re-entry event, additional re-entries will NOT be credited and ALL OF THE USERS ORIGINAL SWAPS WILL STILL BE ACTIVE FOR THE DURATION OF THE EVENT.</p>
<p>User will still receive any applicable rewards for each tournament receipt that is uploaded.</p>
<p>&nbsp;</p>
<p>Responsibility for Taxes: You agree that you are solely responsible for all applicable federal, state, or provincial withholding, taxes, and government fees or costs associated with Swap Profit Rewards and any exchanges and distributions. We may ask you for a valid tax identification number for reporting purposes. Tax forms, such as an IRS Form 1099, may be issued in your name for the actual value of Rewards that we send you.</p>
<p>&nbsp;</p>
<p>Swap Profit Payout – Poker Tournaments</p>
<p>The following earnings will NOT be included in any poker tournament payouts:</p>
<ul>
  <li>Bounties</li>
  <li>High Hands</li>
  <li>Tournament Seat Entries</li>
  <li>Add-Ons of any kind</li>
  <li>Rebuys</li>
</ul>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>We may cancel unconfirmed accounts or accounts that have been inactive for a long time. Additionally, we reserve the right to refuse, modify, or terminate all or part of our Services to anyone for any reason at our discretion.</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>Commercial Use: The Service is for your personal use. Unless otherwise expressly authorized herein or in the Service, you agree not to display, distribute, license, perform, publish, reproduce, duplicate, copy, create derivative works from, modify, sell, resell, exploit, transfer or upload for any commercial purposes, any portion of the Service, use of the Service, or access to the Service.</p>
<p>&nbsp;</p>
<p>Apple-Enabled Software Applications</p>
<p>Swap Profit offers Software applications that are intended to be operated in connection with products made commercially available by Apple Inc. (“Apple”), among other platforms. With respect to Software that is made available for your use in connection with an Apple-branded product (such Software, “Apple-Enabled Software”), in addition to the other terms and conditions set forth in these Terms of Service, the following terms and conditions apply:</p>
<p>&nbsp;</p>
<p>Swap Profit and you acknowledge that these Terms of Service are concluded between Swap Profit and you only, and not with Apple, and that as between Swap Profit and Apple, Swap Profit, not Apple, is solely responsible for the Apple-Enabled Software and the content thereof.</p>
<p>&nbsp;</p>
